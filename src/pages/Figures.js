...
const Figures = () => {
    ...
    return (
        <div className="container mx-auto px-4">
            <h2 className="text-2xl md:text-3xl font-bold text-center mb-2">Nhân Vật Lịch Sử</h2>
            ...
            >
                <div className="flex flex-col items-center">
                    ...
                    />
                    <p className='text-sm md:text-base text-justify'>{selectedCharacter?.desc}</p>
                </div>
            </Modal>
        </div>
    );
